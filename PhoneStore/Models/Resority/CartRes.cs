...
namespace PhoneStore.Models.Resority
{
    public class CartRes: ICartRes
    {
        ...
        public CartRes(UserManager<ApplacationUser> userManager , ApplicationDb db ,
        ...
        public async Task<bool> DoCheckout()
        {
            ...
            try
            {
                ...
                ApplacationUser usertest = await _userManager.FindByIdAsync(userId);
        ...
        // ViewBag for suppliers in Getusercart.cshtml
